# PLAN_CURSO.md — Especificación del Proyecto para Educación

> **Nota:** Este documento es el plan maestro original del curso de MercadoTech (Sesiones 1–7). Se preserva intacto como referencia histórica y como guía para futuras sesiones. El README en la raíz es ahora el manual del producto.
>
> **Fecha de preservación:** Sesión 7 (2026-09-02)
